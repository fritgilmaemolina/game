                            ...
                            if (deckList[xy1].number >= deckList[xy].number) {
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  title: const Text(
                                      'Not Guessed.Play Again?'),
                                  content: const Text(
                                      'The game is over.Press OK to back home page'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {
                                        Navigator.push(
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  title: const Text(
                                      'Not Guessed! Play Again?'),
                                  content: const Text(
                                      'The Game is over! Press OK to revert back to home page'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {
                                        Navigator.push(
                            ...
                            if ((_counter == 52)) {
                              showDialog(
                                ...
                                builder: (BuildContext context) => AlertDialog(
                                  ...
                                  content: const Text(
                                      'You guessed all the cards! Press OK to  back home page'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {
                                        Navigator.push(
