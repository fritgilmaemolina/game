      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
              'CARD GAME! guest the Card either High or Low hope you will enjoy ! ',
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontFamily: 'PressStart2P-Regular',
                  fontSize: 25,
      ...
      onPressed: () {
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: const Text(
              'This game is a game of chance. Just click "High" for high, "Low" for low and "Next" for next card',
              textAlign: TextAlign.center,
              style: TextStyle(
                  fontFamily: 'PressStart2P-Regular',
                  fontSize: 25,
